...
const BengkelMontir = () => {
  const [eduData, setEduData] = useState([
    { id: 1, nama: 'Asep Kurang Kasep', status: 'Aktif' , keahlian :'Sistem Suspensi dan kaki kaki'},
    { id: 2, nama: 'Ujang ga Bujang ', status: 'Tidak Aktif' ,keahlian :'Sistem Suspensi dan kaki kaki'},
    // ... more data
  ]);
  ...
  <button
    onClick={handleAdd}
    className="bg-gray-500 hover:bg-red-700 text-gray-100 font-bold py-2 px-4 rounded"
  >
    Tambah
  </button>
</div>
  ...
  <thead className="bg-gray-500 text-gray-100">
    <tr>
      ...
      <th className="py-3 px-6 text-left">Keahlian</th>
  ...
  <tbody>
    {eduData.map((edu) => (
      <tr key={edu.id} className="bg-gray-100 hover:bg-gray-50">
        ...
        <td className="py-4 px-6">{edu.status}</td>
        <td className="py-4 px-6">{edu.keahlian}</td>
      ...
      >
        <div className="p-6 w-full max-w-md bg-gray-100">
          <h2 className="text-3xl font mb-4 text-red-600">Tambah Montir</h2>
          <form >
            <div className="mb-4">
    ...
    <option value="Tidak Aktif">Tidak Aktif</option>
            ...
            <div className="mb-4">
              ...
              <textarea
                id="keahlian"
                name="keahlian"
                value={newEdu.keahlian}
                onChange={(e) => setNewEdu({ ...newEdu, keahlian: e.target.value })}
                rows="4"
                className="mt-1 p-2 border rounded-md w-full"
              />
            </div>
